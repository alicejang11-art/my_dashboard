...
st.info(
    "💡 **인사이트**\n"
    "- 전반적으로 현지 청년실업률이 낮은(고용 안정적인) 국가일수록 한국인 취업자 수가 많아지는 음의 상관관계가 나타나는 것처럼 보입니다.\n"
    "- 미국은 실업률 8~12% 구간에서도 500~1,600명대를 유지하며 추세선 예외 국가로, 실업률 외 요인(높은 임금, 영어권 선호)이 작용하고 있음을 시사합니다.\n"
